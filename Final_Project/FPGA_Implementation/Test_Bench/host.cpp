...
int main(int argc, char** argv) {
    ...
    std::cout << "  Steps 0-19:  THROTTLE UP\n";
    std::cout << "  Steps 20-29: HOVER\n";
    std::cout << "  Steps 30-39: ROLL RIGHT\n";
    std::cout << "  Steps 40-49: ROLL LEFT\n";
    std::cout << "  Steps 50-59: PITCH FORWARD\n";
    std::cout << "  Steps 60-69: PITCH BACKWARD\n";
    std::cout << "  Steps 70-79: YAW RIGHT\n";
    std::cout << "  Steps 80-84: YAW LEFT\n";
